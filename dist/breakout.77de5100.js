...
exports.createGrid = exports.createGridFromData = exports.gridData2 = exports.gridData = void 0;
exports.gridData = {
  rows: 20,
  cols: 20,
  bricks: [{
...
function createGridFromData(width, height, data) {
  var w = width / data.cols;
  var h = height / data.rows;
  var bricks = [];

  for (var _i = 0, _a = data.bricks; _i < _a.length; _i++) {
    var brick = _a[_i];
...
function render(context, canvas, particles, brickColors, bgPattern, d) {
  ...
  context.beginPath();
  context.rect(d.paddle.x - d.paddle.width / 2, context.canvas.height - d.paddle.height, d.paddle.width, d.paddle.height);
  context.fill();
...
},{}],"assets/pattern3.jpeg":[function(require,module,exports) {
...
var particles = new particles_1.Particles(context);
var data = {
  shooting: {
    munition: 0
  },
...
data.bricks = grid_factory_1.createGridFromData(width, height, grid_factory_1.gridData2);
...
})), rxjs_1.fromEvent(window, 'keyup').pipe(operators_1.map(function (e) {
  return 0;
})));
var mousePos$ = rxjs_1.fromEvent(window, 'mousemove').pipe(operators_1.map(function (e) {
  return e.pageX;
}));
...
var state$ = $tick.pipe(operators_1.withLatestFrom(keyboardPos$), operators_1.withLatestFrom(keyboardShoot$), operators_1.scan(function (acc, _a) {
  var _b = _a[0],
      tick = _b[0],
      pos = _b[1],
      shoot = _a[1];
  var zeit0 = performance.now(); // Handle shooting
  ...
  for (var _d = 0, _e = acc.gems; _d < _e.length; _d++) {
    var gem = _e[_d];
    gem.y += 2;
  ...
  acc.gems = acc.gems.filter(function (g) {
    return !g.out;
  });

  for (var _f = 0, _g = acc.shoots; _f < _g.length; _f++) {
    var shoot_1 = _g[_f];

    for (var _h = 0, _j = acc.bricks.filter(function (b) {
      return !b.hit;
    }); _h < _j.length; _h++) {
      var brick = _j[_h];
...
state$.subscribe(function (d) {
  render_1.render(context, canvas, particles, types_1.brickColors, bgPattern, data);
});
var img = new Image();
...
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js","./grid.factory":"grid.factory.ts","./particles":"particles.ts","./render":"render.ts","./types":"types.ts","./assets/pattern3.jpeg":"assets/pattern3.jpeg"}],"../../../Tools/Node/node-v12.14.1-darwin-x64/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
